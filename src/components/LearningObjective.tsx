      ...
      <div className="p-3 sm:p-4 space-y-2 sm:space-y-3">
        <div className="flex flex-wrap sm:flex-nowrap items-start sm:items-center gap-2 sm:gap-3">
          <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
            <div className="flex-shrink-0 p-1.5 sm:p-2 bg-blue-100 dark:bg-blue-900/30 rounded-md group relative">
              <svg 
              ...
              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-1 px-1.5 py-0.5 text-2xs sm:text-xs text-white bg-gray-800 dark:bg-gray-700 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-200 whitespace-nowrap pointer-events-none">
                Learning Objective
              </div>
            </div>
            <div className="flex-grow min-w-0">
              <div className="text-xs sm:text-xs text-gray-600 dark:text-gray-400 mb-1 mt-0">
